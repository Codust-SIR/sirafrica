...
export default function Donate() {
  ...
  const subs: {
    ...
    {
      image: "/img6.jpeg",
      name: "Connected Learning (Higher Education)",
      description:
        "Facilitating pathways to higher education for refugee youth.",
    },
  ];
  const responsive = {
    superLargeDesktop: {
      ...
      <HideAppBar>
        <Box>
          ...
          <CenteredBox textAlign={"center"}>
            ...
            >
              Our education program aims to strengthen market-driven skills
              development training, advanced digital skills and employability
              skills that create dignified job opportunities and increase income
