...
const DonateCard = () => {
  ...
  const [isAnonymous, setIsAnonymous] = useState(false);
    ...
    const [onAddingCreditCardError, setOnAddingCreditCardError] = useState<string>("")
...
const Section: React.FC<{
    ...
    handleSubmitDonation:()=>void;
          ...
          donationType,
          onDonationType,
          editInfo, handleOnCreditCardMMChange, handleOnCreditCardNumberChange, handleOnCreditCardYYYYChange, creditCardYYYY, handleOnCreditCardHolderNameChange, handleOnCreditCardCVVChange, creditCardMM, creditCardCVV, creditCardHolderName, creditCardNumber
,onAddingCreditCardError,handleSubmitDonation
      }) => {
    switch (value) {
        case 0:
            return (
...
const PaymentMethod: React.FC<{
    ...
    handleSubmitDonation:()=>void;
          ...
          amount, donationType, email, fullName, isAnonymous, editInfo, handleOnCreditCardMMChange, handleOnCreditCardNumberChange, handleOnCreditCardYYYYChange, creditCardYYYY, handleOnCreditCardHolderNameChange, handleOnCreditCardCVVChange, creditCardMM, creditCardCVV, creditCardHolderName, creditCardNumber, onAddingCreditCardError,handleSubmitDonation
      }) => {
                        ...
                        <Box sx={{display: "flex", alignItems: "center", gap: 1}}>
                            ...
                            >
                                ...
                                <OutlinedInput
                                    ...
                                    label="MM"
                                    value={creditCardMM}
                                    onChange={event => handleOnCreditCardMMChange(Number(event.target.value))}
                                />
                            </FormControl>
                            <FormControl
                                size={"small"}
